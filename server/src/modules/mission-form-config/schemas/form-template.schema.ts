 ...
 * đúng ô "Điểm tự chấm" trong bảng nhiệm vụ.
 */
...
/** Mẫu bảng nhiệm vụ - bộ cột + header gộp, gán cho một hoặc nhiều trục. */
@Schema({ timestamps: true, collection: 'mission_form_templates' })
