 ...
 *
 * Khác nhiệm vụ ở chỗ dòng không do cán bộ khai: admin khai sẵn tiêu chí và
 * điểm tối đa, người chấm chỉ điền kết quả vào các cột. Bộ cột của bảng cấu
 * hình bằng Mẫu bảng nhiệm vụ y như một trục lấy bộ cột của nó - xem cờ `forCriteria`
 * trong form-template.schema.ts.
 */
@Schema({ timestamps: true, collection: 'mission_criteria' })
