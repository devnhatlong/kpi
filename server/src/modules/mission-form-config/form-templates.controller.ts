...
@Controller('mission-form-config/form-templates')
export class FormTemplatesController {
  constructor(private readonly formTemplatesService: FormTemplatesService) {}

  @ApiOperation({ summary: 'Tạo mẫu bảng nhiệm vụ' })
  ...
  @ApiOperation({ summary: 'Danh sách mẫu bảng nhiệm vụ' })
  ...
  @ApiOperation({ summary: 'Cập nhật mẫu bảng nhiệm vụ' })
  @Permissions(Permission.MISSION_MANAGE)
  @Patch(':id')
  ...
  @ApiOperation({ summary: 'Xoá mẫu bảng nhiệm vụ' })
  @Permissions(Permission.MISSION_MANAGE)
  @Delete(':id')
