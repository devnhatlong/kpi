...
/**
 * Tiền tố riêng chứ không nằm dưới /personal-mission: controller đó có @Get(':id')
 * bắt mọi đoạn đường còn lại, thêm route con vào sẽ bị nó nuốt.
 */
@ApiTags('Mission Summary Reports')
@ApiBearerAuth()
@UseGuards(JwtGuard, PermissionsGuard)
@Permissions(Permission.EVALUATION_APPROVE)
@Controller('mission-summary-reports')
export class MissionSummaryReportsController {
  constructor(private readonly service: MissionSummaryReportsService) {}
