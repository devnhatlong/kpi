...
type TaskEntryCardProps = {
  ...
  /** Ghi chú admin khai ở danh mục - cột "Ghi chú" của bảng nhiệm vụ. */
  contentNote?: string;
 ...
 * Các ô trong thẻ dựng theo mẫu nhiệm vụ của trục chứa nội dung đó, nên hai nội dung
      ...
      {collapsed ? null : !hasTemplate ? (
        <div className="flex flex-col items-center gap-2 border-t border-dashed border-amber-500/40 bg-amber-500/5 p-6 text-center">
          ...
          <p className="max-w-md text-xs text-muted-foreground">
            ...
            form nhiệm vụ › Mẫu bảng nhiệm vụ.
          </p>
        </div>
      ) : (
