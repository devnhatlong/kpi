...
import type { ReviewScoreReport } from "@/features/personal-kpi/review-scores";
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {report.lowered ? (
          <Badge
            variant="secondary"
            className={cn("shrink-0 font-normal", kpiTone.danger.soft)}
          >
          ...
          <Badge
            variant="secondary"
            className={cn("shrink-0 font-normal", kpiTone.success.soft)}
          >
            Chỉ huy chấm lại
          </Badge>
        ) : (
