...
import { WorkTaskFormDialog } from "@/features/kpi-form-config/components/work-task-form-dialog";
...
export function WorkTasksView() {
  ...
  const { data, isLoading, mutate } = useSWR(workTaskKeys.list(listParams), () =>
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            dropdown khi nhập KPI, không tự gõ.
          </p>
        </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-[240px]">Nội dung công việc</TableHead>
