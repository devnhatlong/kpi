...
import { countSelectedTargets } from "@/features/mission-assignment/types";
        ...
        >
          ...
          {node.isUnit ? (
            ...
            <span
              ...
              title={`${node.levelName || "Cấp này"} chỉ gom nhóm, không nhận nhiệm vụ`}
            />
          )}
          ...
          <div className="space-y-0.5 border-b bg-muted/40 px-3 py-2">
            ...
            <p className="text-[11px] text-muted-foreground">
              {scope.isEnabled
                ...
                : "Vai trò của bạn chưa được cấp quyền giao nhiệm vụ."}
            </p>
          </div>
        ) : null}
