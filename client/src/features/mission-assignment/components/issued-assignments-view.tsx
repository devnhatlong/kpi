...
import { AssignTaskDrawer } from "@/features/mission-assignment/components/assign-task-drawer";
...
export function IssuedAssignmentsView() {
  ...
  const [rejecting, setRejecting] = useState<MissionAssignment | null>(null);
  const [rejectReason, setRejectReason] = useState("");
  const [acting, setActing] = useState(false);

  const approve = async (item: MissionAssignment) => {
    setActing(true);
    try {
