...
import type { DesignerTarget } from "@/features/mission-form-config/components/report-builder/form-draft";
import {
  entityId,
      ...
      <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            placeholder={`Mẫu báo cáo nhiệm vụ năm ${year}`}
          />
        </div>
          ...
          <div className="space-y-2 p-2">
            {axes.length === 0 ? (
              ...
              axes.map((axis) => {
                ...
                */
                const order = checked ? pickedAxisIds.indexOf(id) + 1 : null;
                return (
                  <div
                    key={id}
                    className={cn(
