...
import { FieldInspector } from "@/features/mission-form-config/components/report-builder/field-inspector";
import {
  allowedDataTypes,
  columnFromPreset,
  FIELD_PRESET_GROUPS,
...
type DragItem =
  { kind: "preset"; preset: FieldPreset } | { kind: "column"; id: string };
          ...
          {columns.length === 0 ? (
            <div className="flex flex-col items-center gap-3 px-4 py-12 text-center">
              <p className="text-sm text-muted-foreground">
                Khối này chưa có trường nào. Bấm một mục ở thư viện bên trái,
                hoặc bắt đầu từ bộ cột dùng sẵn.
              </p>
              <Button
                type="button"
                variant="outline"
