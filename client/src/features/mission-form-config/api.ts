...
export async function fetchAxesPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<Axis[]>>("/mission-form-config/axes/all", {
...
export function createAxis(input: AxisInput) {
  return unwrapData(
    api.post<ApiResponse<Axis>>("/mission-form-config/axes", input),
  );
}

export function updateAxis(id: string, input: Partial<AxisInput>) {
  return unwrapData(
    api.patch<ApiResponse<Axis>>(`/mission-form-config/axes/${id}`, input),
  );
}

export async function deleteAxis(id: string) {
  await api.delete(`/mission-form-config/axes/${id}`);
}
...
export async function fetchCriteriaPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<Criterion[]>>("/mission-form-config/criteria/all", {
      params: buildListQuery(params),
    }),
  );
}
...
export function fetchCriteriaSummary() {
  return unwrapData(
    api.get<ApiResponse<CriteriaSummary>>(
      "/mission-form-config/criteria/summary",
    ),
  );
}
...
export function createCriterion(input: CriterionInput) {
  return unwrapData(
    api.post<ApiResponse<Criterion>>("/mission-form-config/criteria", input),
  );
}

export function updateCriterion(id: string, input: Partial<CriterionInput>) {
  return unwrapData(
    api.patch<ApiResponse<Criterion>>(
      `/mission-form-config/criteria/${id}`,
      input,
    ),
  );
}
...
export function createWorkContent(input: WorkContentInput) {
  return unwrapData(
    api.post<ApiResponse<WorkContent>>(
      "/mission-form-config/work-contents",
      input,
    ),
  );
}
...
export function updateWorkContent(
  ...
  return unwrapData(
    api.patch<ApiResponse<WorkContent>>(
      `/mission-form-config/work-contents/${id}`,
      input,
    ),
  );
}
...
export async function deleteWorkContent(id: string) {
  await api.delete(`/mission-form-config/work-contents/${id}`);
}
...
export async function fetchWorkTasksPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<WorkTask[]>>("/mission-form-config/work-tasks/all", {
      params: {
...
export function createWorkTask(input: WorkTaskInput) {
  return unwrapData(
    api.post<ApiResponse<WorkTask>>("/mission-form-config/work-tasks", input),
  );
}
...
export function updateWorkTask(id: string, input: Partial<WorkTaskInput>) {
  return unwrapData(
    api.patch<ApiResponse<WorkTask>>(
      `/mission-form-config/work-tasks/${id}`,
      input,
    ),
  );
}
...
export async function deleteWorkTask(id: string) {
  await api.delete(`/mission-form-config/work-tasks/${id}`);
}
...
export async function fetchScoreGroupsPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<ScoreGroup[]>>(
      "/mission-form-config/score-groups/all",
      {
        params: buildListQuery(params),
      },
    ),
...
export function createScoreGroup(input: ScoreGroupInput) {
  return unwrapData(
    api.post<ApiResponse<ScoreGroup>>(
      "/mission-form-config/score-groups",
      input,
    ),
  );
}
...
export function updateScoreGroup(id: string, input: Partial<ScoreGroupInput>) {
  return unwrapData(
    api.patch<ApiResponse<ScoreGroup>>(
      `/mission-form-config/score-groups/${id}`,
      input,
    ),
  );
}
...
export async function deleteScoreGroup(id: string) {
  await api.delete(`/mission-form-config/score-groups/${id}`);
}
...
export async function fetchQualityLevelsPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<QualityLevel[]>>(
      "/mission-form-config/quality-levels/all",
      { params: buildListQuery(params) },
    ),
  );
}
...
export function createQualityLevel(input: QualityLevelInput) {
  return unwrapData(
    api.post<ApiResponse<QualityLevel>>(
      "/mission-form-config/quality-levels",
      input,
    ),
  );
}
...
export function updateQualityLevel(
  ...
  return unwrapData(
    api.patch<ApiResponse<QualityLevel>>(
      `/mission-form-config/quality-levels/${id}`,
      input,
    ),
  );
}
...
export async function deleteQualityLevel(id: string) {
  await api.delete(`/mission-form-config/quality-levels/${id}`);
}
...
export async function fetchFormTemplatesPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<FormTemplate[]>>(
      "/mission-form-config/form-templates/all",
      {
        params: buildListQuery(params),
      },
    ),
...
export async function fetchFormTemplateByAxis(
  ...
  const data = await unwrapData(
    api.get<ApiResponse<FormTemplate | null>>(
      `/mission-form-config/form-templates/by-axis/${axisId}`,
    ),
  );
  return data ?? null;
}
...
export function createFormTemplate(input: FormTemplateInput) {
  return unwrapData(
    api.post<ApiResponse<FormTemplate>>(
      "/mission-form-config/form-templates",
      input,
    ),
  );
}
...
export function updateFormTemplate(
  ...
  return unwrapData(
    api.patch<ApiResponse<FormTemplate>>(
      `/mission-form-config/form-templates/${id}`,
      input,
    ),
  );
}
...
export async function deleteFormTemplate(id: string) {
  await api.delete(`/mission-form-config/form-templates/${id}`);
}
...
export async function fetchReportTemplatesPage(
  ...
  return unwrapPaginated(
    api.get<ApiResponse<ReportTemplate[]>>(
      "/mission-form-config/report-templates/all",
      { params: buildListQuery(params) },
    ),
  );
}
...
export function fetchReportTemplate(id: string) {
  return unwrapData(
    api.get<ApiResponse<ReportTemplate>>(
      `/mission-form-config/report-templates/${id}`,
    ),
  );
}
...
export function fetchMyReportScope(year?: number) {
  return unwrapData(
    api.get<ApiResponse<ResolvedReportScope>>(
      "/mission-form-config/report-templates/mine",
...
export function fetchReportScopeForDepartment(
  ...
  return unwrapData(
    api.get<ApiResponse<ResolvedReportScope>>(
      `/mission-form-config/report-templates/resolve/${departmentId}`,
      { params: year ? { year } : undefined },
    ),
  );
}
...
export function createReportTemplate(input: ReportTemplateInput) {
  return unwrapData(
    api.post<ApiResponse<ReportTemplate>>(
      "/mission-form-config/report-templates",
      input,
    ),
  );
}
...
export function applyReportTemplate(id: string) {
  return unwrapData(
    api.post<ApiResponse<ReportTemplate>>(
      `/mission-form-config/report-templates/${id}/apply`,
    ),
  );
}
...
export function unapplyReportTemplate(id: string) {
  return unwrapData(
    api.post<ApiResponse<ReportTemplate>>(
      `/mission-form-config/report-templates/${id}/unapply`,
    ),
  );
}

export async function deleteReportTemplate(id: string) {
  await api.delete(`/mission-form-config/report-templates/${id}`);
}
