import type {
  PersonalMissionBoardAxis,
  PersonalMissionBoardRow,
 ...
 */
export type SummaryAxisBlock = PersonalMissionBoardAxis;
export type SummaryRow = PersonalMissionBoardRow;
...
/** Nhiệm vụ gõ tay vào báo cáo - việc không đi qua nhiệm vụ cá nhân. */
...
export type SummaryReport = {
  ...
  scopeName: string;
  status: SummaryReportStatus;
  /** Số nhiệm vụ lấy từ nhiệm vụ - chưa tính nhiệm vụ tự nhập. */
  itemCount: number;
