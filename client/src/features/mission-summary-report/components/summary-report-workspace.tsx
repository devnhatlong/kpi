...
import { CreateReportWizard } from "@/features/mission-summary-report/components/create-report-wizard";
import {
  SummaryReportListPanel,
  type ReportScope,
  type ReportTab,
} from "@/features/mission-summary-report/components/summary-report-list-panel";
import { SummaryReportPanel } from "@/features/mission-summary-report/components/summary-report-panel";
import type {
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {incoming
                  ...
                  : "Tổng hợp việc cấp dưới đã hoàn thành và việc đơn vị tự khai, rồi trình lên cấp trên."}
              </p>
            </div>
          </div>
