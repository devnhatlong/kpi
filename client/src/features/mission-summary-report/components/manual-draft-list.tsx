...
import { ManualEntryForm } from "@/features/mission-summary-report/components/manual-entry-form";
 ...
 * của chính đơn vị, việc phối hợp, việc đột xuất không đi qua nhiệm vụ cá nhân nên
    ...
    <div className="space-y-3">
      ...
      */}
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-lg border bg-muted/40 px-3 py-2 text-sm">
        ...
        <span className="text-muted-foreground">
          Tổng điểm{" "}
          <span className={cn("font-semibold", missionTone.success.text)}>
