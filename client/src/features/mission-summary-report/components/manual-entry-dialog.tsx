...
import type { SummaryManualItemInput } from "@/features/mission-summary-report/api";
import {
  ManualEntryForm,
  type ManualEntryValue,
} from "@/features/mission-summary-report/components/manual-entry-form";
 ...
 * nào có bản ghi nhiệm vụ đứng sau, số nào do người lập gõ vào.
 */
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Dành cho việc không có trong nhiệm vụ cá nhân. Dòng này sẽ mang nhãn
