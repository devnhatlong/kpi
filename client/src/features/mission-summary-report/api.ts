...
const BASE = "/mission-summary-reports";

export const summaryReportKeys = {
  all: ["mission-summary-reports"] as const,
  stats: ["mission-summary-reports", "stats"] as const,
  ...
  detail: (id: string) => ["mission-summary-reports", "detail", id] as const,
};
