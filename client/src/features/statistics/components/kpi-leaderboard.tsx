  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-base">Bảng xếp hạng KPI</CardTitle>
        <p className="text-xs text-muted-foreground">
          Tổng điểm quy đổi của các trục trong khoảng đang xem. Xếp loại lấy theo
          danh mục Nhóm điểm đang cấu hình.
        </p>
      </CardHeader>
              ...
              <Table className="min-w-[640px]">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-[220px]">Điểm KPI</TableHead>
