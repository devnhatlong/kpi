...
function cloneTemplateHeaderGroups(
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="text-[10px] leading-snug text-muted-foreground">
        Chọn lớp gộp cuối cùng (vd: Kết quả tiến độ). Tên cột cuối nhập ở Nhãn
        cột.
      </div>
    </div>
  );
...
function generateTemplateCode(): string {
  return `MISSION_${Date.now().toString(36).toUpperCase()}`;
}
...
export function TemplateConfigView({
  ...
  const [newTemplateScope, setNewTemplateScope] =
    useState<CatalogScope>("SYSTEM");
  ...
  const templatesQuery = useSWR(missionConfigKeys.templates(listScope), () =>
    listScope ? fetchMissionTemplates(listScope) : fetchMissionTemplates(),
  );
  ...
  const setTemplateHeaderGroups = (
    action: SetStateAction<TemplateHeaderGroup[]>,
  ...
  const addCustomColumn = () => {
    ...
    setColumns((current) => [
      ...current,
      column(`custom_${suffix}`, "Cột tùy chỉnh", 140, defaultRoleCode, "text"),
    ]);
  };
  ...
  const openTemplateDialog = (
    ...
    setNewTemplateCode(
      mode === "edit" && template ? template.code : generateTemplateCode(),
    );
    ...
    setNewIsActive(mode === "create" ? true : (template?.isActive ?? true));
    if (mode === "create") {
  ...
  const submitTemplateDialog = async () => {
    ...
    try {
      if (templateDialogMode === "edit") {
        ...
        const updated = await updateMissionTemplate(selectedTemplateId, {
          name,
          code,
        ...
        const created = await createMissionTemplate(toTemplateInput(draft));
  ...
  const deleteTemplate = async () => {
    ...
    setSaving(true);
    try {
      await deleteMissionTemplate(selectedTemplateId);
  ...
  const saveDraft = async () => {
    ...
    if (columns.length) {
      ...
      if (
        columns.some(
          (item) => !item.inputRoleCode && !isAutoIncrementColumn(item),
        )
      ) {
    ...
    setSaving(true);
    try {
      const updated = await updateMissionTemplate(
        selectedTemplateId,
      ...
      toast.error(
        getApiErrorMessage(error, "Không lưu được cấu hình biểu mẫu."),
      );
    } finally {
      setSaving(false);
    }
          ...
          <div className="space-y-2 p-2">
            {templatesQuery.isLoading ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center text-xs text-muted-foreground">
                {isDepartmentScope
                  ? "Chưa có biểu mẫu nội bộ. Tạo biểu mẫu rồi dùng ở trang Form nhiệm vụ."
                  : "Chưa có biểu mẫu"}
              </div>
            )}
          </div>
            ...
            >
              ...
              <TabsContent value="columns" className="space-y-3">
                ...
                <div className="rounded-md border bg-muted/20 p-3">
                  ...
                  <HeaderPreviewTable columns={columns} groups={headerGroups} />
                </div>
              </TabsContent>
              ...
              <TabsContent value="contents" className="space-y-3">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      Bật nội dung công việc sẽ xuất hiện khi giao nhiệm vụ.
                      Phải chọn ít nhất một nội dung rồi bấm Lưu cấu hình.
                    </div>
                  </div>
                  <div className="flex gap-2">
                    {!activeReadOnly ? (
              ...
              <TabsContent value="workflow" className="space-y-4">
                ...
                <div className="grid max-w-2xl gap-4 rounded-md border p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      MANY_TASKS: Unit Admin có thể thêm nhiều nhiệm vụ dưới mỗi
                      nội dung.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-xs text-muted-foreground">
                        Chỉ map từ danh mục đã chọn trên biểu mẫu, không cho sửa
                        tay khi thêm nhiệm vụ.
                      </span>
                    </span>
                  </label>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewTemplateVisibilityScope(
                    value as TemplateVisibilityScope,
                  )
                }
              >
                <SelectTrigger className="h-9">
            ...
            <div className="flex items-center justify-between rounded-md border px-3 py-2.5">
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  Tắt để ẩn biểu mẫu khỏi danh sách dùng khi giao nhiệm vụ.
                </div>
              </div>
              <Switch
                checked={newIsActive}
      ...
      <Dialog open={groupDialogOpen} onOpenChange={setGroupDialogOpen}>
        <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
          ...
          <div className="space-y-3">
            <div className="text-xs text-muted-foreground">
              Chỉ tạo các lớp gộp header (vd: Điểm tự chấm → Kết quả tiến độ).
              Tên cột cuối như “Thực tế hoàn thành %” nhập ở Nhãn cột, không cần
              tạo thành nhóm con.
            </div>
